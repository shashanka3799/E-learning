...
<thead>
<tr><th>Faculty Id</th><th>Name</th><th>Branch</th><th>Designation</th><th>Subjects</th><th>Email ID</th><th>Phone No.</th><th></th></tr>
</thead>
<tbody>
		<%try {
		...
		try{ 
			...
			String sql ="SELECT * FROM faculty where status = 1";
